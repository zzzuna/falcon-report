...
export function HandoverReadinessSection({ items, pageBreak }) {
    if (!items || items.length === 0) return null;
    return (
        <section id="readiness" className={`mb-10 print:break-inside-avoid ${pageBreak ? 'print:break-before-page' : ''}`}>
            <div className="border-b-2 border-slate-800 pb-2 mb-6 print:break-after-avoid">
                <h2 className="text-xl font-black text-slate-900 uppercase tracking-widest">Pre-Handover Readiness</h2>
            </div>
