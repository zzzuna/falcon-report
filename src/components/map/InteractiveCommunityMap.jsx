    ...
    return (
        <section id="community-map" className="mb-10 print:hidden relative">
            ...
            <div className="relative bg-slate-100 rounded-xl overflow-hidden border border-slate-200 shadow-sm select-none">
                ...
                {/* Map Legend */}
                <div className="absolute top-4 right-4 bg-white/95 backdrop-blur border border-slate-200 p-3.5 rounded-lg shadow-md z-20 flex flex-col gap-2 pointer-events-auto transition-transform">
                    <h5 className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-0.5">Villa Status (Map Overlay)</h5>
                    <div className="flex items-center gap-2 text-[11px] font-bold text-slate-700"><div className="w-3 h-3 bg-[#8bc34a] border border-[#689f38] rounded-sm opacity-90"></div>Handed Over (Green)</div>
                    <div className="flex items-center gap-2 text-[11px] font-bold text-slate-700"><div className="w-3 h-3 bg-[#0288d1] border border-[#01579b] rounded-sm opacity-90"></div>Not Accepted (Blue)</div>

                    <div className="border-t border-slate-100 my-1"></div>

                    <h5 className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-0.5">Projects</h5>
                    <div className="grid grid-cols-2 gap-x-4 gap-y-2">
                        <div className="flex items-center gap-2 text-[11px] font-bold text-slate-700"><div className="w-3 h-3 bg-emerald-500 rounded-full border border-white shadow-sm"></div>Completed</div>
                        <div className="flex items-center gap-2 text-[11px] font-bold text-slate-700"><div className="w-3 h-3 bg-orange-500 rounded-full border border-white shadow-sm"></div>In Progress</div>
                        <div className="flex items-center gap-2 text-[11px] font-bold text-slate-700"><div className="w-3 h-3 bg-blue-500 rounded-full border border-white shadow-sm"></div>Planned</div>
                        <div className="flex items-center gap-2 text-[11px] font-bold text-slate-700"><div className="w-3 h-3 bg-rose-500 rounded-full border border-white shadow-sm"></div>Cancelled</div>
                    </div>
                </div>
